  ...
  <body>
    ...
    <?php require '../HeaderCoProf.php'; ?>
        ...
        <div id="SectionEnseignants">
          <?php
          $sql = "SELECT * FROM intervenant WHERE `specialite`= 'Nanoscience et nanotechnologie pour l ingenierie'";
          $result = mysqli_query($conn, $sql);
          while($data = mysqli_fetch_assoc($result)){   
            $prenom = $data['Prenom'];
            $nom = $data['Nom'];
        ...
        <div style="text-align:center ; padding : 20px">
            <a class="btn btn-outline-light btn-lg px-5" href="RechercheProf.php">Retour</a>
        </div>
