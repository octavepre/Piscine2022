  ...
  <body>
    ...
    <?php require '../Header.html'; ?>
        ...
        <div id="SectionEnseignants">
          <?php
          $sql = "SELECT * FROM intervenant WHERE `specialite`= 'Mathematiques pour l ingenierie'";
          $result = mysqli_query($conn, $sql);
          while($data = mysqli_fetch_assoc($result)){   
            $prenom = $data['Prenom'];
            $nom = $data['Nom'];
            ...
            <div class='row'>
              <div class='col-sm'>
                  ...
                  <div class='col-sm'> <!--Changer la mise en page utiliser tr td th-->
                      <div class='row'>
                        <div class='col-sm'>
                          <h2 class='NameEnsei'>".$prenom." ".$nom." </h2><p class='SpecEnsei'><i>(Enseignant Chercheur)</i><p>
        ...
        <div style="text-align:center ; padding : 20px">
            <a class="btn btn-outline-light btn-lg px-5" href="Recherche.php">Retour</a>
        </div>
