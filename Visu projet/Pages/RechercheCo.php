            ...
            <div class="carousel-inner">
              <div class="carousel-item active" data-interval="5000">
                ...
                <div id="Caroussel_text">
                    ...
                    <a class="btn btn-light my-2 my-sm-0" href="SICCo.php">Voir plus</a>
                </div>
              </div>
              <div class="carousel-item" data-interval="5000">
                ...
                <div id="Caroussel_text">
                    ...
                    <a class="btn btn-light my-2 my-sm-0" href="MPICo.php">Voir plus</a>
                </div>
              </div>
              <div class="carousel-item" data-interval="5000">
                ...
                <div id="Caroussel_text">
                    ...
                    <a class="btn btn-light my-2 my-sm-0" href="NNICo.php">Voir plus</a>
                </div>
              </div>
            </div>
