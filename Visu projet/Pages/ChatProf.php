...
<body>
	<div>
	<?php
	$sql2 = "SELECT * FROM `chat` WHERE `id_inter` = (SELECT `ID`	FROM `intervenant` WHERE Nom = '".$_SESSION['NomClientActuel']."') AND mail_utilisateur LIKE '%@%' OR mail_utilisateur = '".$_SESSION['NomClientActuel']."' ORDER BY id DESC";
