  ...
  <body>
    <div class="containerfluid" id="wrapper">
      <?php require '../HeaderCoProf.php'; ?>
        ...
        <a   id="btnParc1" class="btn btn-outline-light my-2 my-sm-0" type="submit" href="EnseignantProf.php">Voir plus</a>
        ...
        <div class="Cadre2">    
            <img  style="opacity: 0.7" src="../Images/Recherche.jpg" class="img_Parc2" alt="Car1">
               ...
               <a id="btnParc2" class="btn btn-outline-light my-2 my-sm-0" type="submit"href="RechercheProf.php">Voir plus</a>
